...
2. [public-qr-login-spec.md](public-qr-login-spec.md)
   扫码登录专用的对外接入协议。

### 内部后台 / 运营

1. [admin-api-spec.md](admin-api-spec.md)
   Admin Web 与后台内部接口协议。
2. [admin-web-design.md](admin-web-design.md)
   Admin Web 的页面模型、工作区与交互设计。
3. [local-cicd-deploy.md](local-cicd-deploy.md)
   本地 / 服务器部署链路说明。
...
1. [bailain/2026-03-29百炼codingPlan.md](bailain/2026-03-29百炼codingPlan.md)
   厂商能力或接入方案记录。
...
1. 面向外部接入方：优先写到 [../README_API.md](../README_API.md) 或 `docs/public-*`
...
仓库级强约束已经写入 [../AGENTS.md](../AGENTS.md)。

执行上按这套理解：

1. 对外接口变化：更新 [../README_API.md](../README_API.md)
2. 内部 admin 接口变化：更新 [admin-api-spec.md](admin-api-spec.md)
3. 后端能力范围明显变化：更新 [current-backend-implementation-overview.md](current-backend-implementation-overview.md)
