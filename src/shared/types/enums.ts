...
export type EventName =
  ...
  | "lighttick_guest_created"
  | "lighttick_account_upgraded"
  | "lighttick_session_recovered"
  | "lighttick_wish_submitted"
  | "lighttick_starter_shown"
  | "lighttick_starter_started"
  | "lighttick_starter_completed"
  | "lighttick_preview_viewed"
  | "lighttick_weekly_commitment"
  | "lighttick_plan_confirmed"
  | "lighttick_task_started"
  | "lighttick_task_completed"
  | "lighttick_task_skipped"
  | "lighttick_task_deferred"
  | "lighttick_goal_paused"
  | "lighttick_goal_resumed"
  | "lighttick_recovery_started"
  | "lighttick_return_observed"
  | "lighttick_review_viewed"
  | "lighttick_proposal_accepted"
  | "lighttick_proposal_rejected"
  | "lighttick_sync_conflict"
  | "lighttick_notification_queued"
  | "lighttick_notification_delivered"
  | "lighttick_notification_suppressed"
  | "lighttick_notification_failed";
...
export type ErrorCode =
  ...
  | "BUDDY_ALREADY_ACTIVE"
  | "BUDDY_ALREADY_PENDING"
  | "BUDDY_BLOCKED"
  | "BUDDY_COOLDOWN_PERIOD"
  | "BUDDY_INVALID_HABITS"
  | "BUDDY_INVALID_PARTNER"
  | "BUDDY_INVITATION_EXPIRED"
  | "BUDDY_LIMIT_REACHED"
  | "BUDDY_NOT_ACTIVE"
  | "BUDDY_NOT_AUTHORIZED"
  | "BUDDY_NOT_PENDING"
  | "BUDDY_PAIR_NOT_FOUND"
  | "BUDDY_PARTNER_NOT_FOUND"
  | "GROUP_ALREADY_MEMBER"
  | "GROUP_FULL"
  | "GROUP_INVALID_HABITS"
  | "GROUP_INVALID_MEMBERS"
  | "GROUP_INVALID_NAME"
  | "GROUP_INVITE_EXPIRED"
  | "GROUP_INVITE_INVALID"
  | "GROUP_INVITE_NOT_FOUND"
  | "GROUP_LEADER_NOT_FOUND"
  | "GROUP_LIMIT_REACHED"
  | "GROUP_NAME_TOO_LONG"
  | "GROUP_NOT_ACTIVE"
