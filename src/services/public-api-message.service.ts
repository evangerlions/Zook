...
const PUBLIC_ERROR_MESSAGE_KEYS = {
  AI_CONTEXT_TOO_LONG: "error.ai.context_too_long",
  ...
  AI_UPSTREAM_AUTH_FAILED: "error.ai.configuration",
  AI_UPSTREAM_BAD_GATEWAY: "error.ai.upstream_bad_gateway",
  AI_UPSTREAM_CONFIG_INVALID: "error.ai.configuration",
  AI_UPSTREAM_INVALID_REQUEST: "error.ai.upstream_bad_gateway",
  AI_UPSTREAM_QUOTA_EXHAUSTED: "error.ai.upstream_bad_gateway",
  AI_UPSTREAM_RATE_LIMITED: "error.ai.rate_limited",
  AI_UPSTREAM_RESPONSE_INVALID: "error.ai.response_format_invalid",
  ...
  LLM_MODEL_NOT_FOUND: "error.ai.configuration",
  LLM_PROVIDER_CONTENT_SENSITIVE: "error.ai.input_content_sensitive",
  LLM_PROVIDER_REQUEST_FAILED: "error.ai.upstream_bad_gateway",
  LLM_PROVIDER_RESPONSE_INVALID: "error.ai.response_format_invalid",
  LLM_ROUTE_NOT_AVAILABLE: "error.ai.configuration",
  LLM_SERVICE_NOT_CONFIGURED: "error.ai.configuration",
