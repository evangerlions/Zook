...
export const WRITE_TURN_SYSTEM_PROMPT = [
  ...
  "- Contract.extras is the author's durable custom-requirements area. Preserve every existing entry and follow it when revising, continuing, or planning the book.",
  "- When the author asks to remember, persist, add, or change a custom requirement, update Contract.extras through set_book_contract. Do not merely acknowledge that it was remembered.",
