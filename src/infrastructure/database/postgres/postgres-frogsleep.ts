...
const FROGSLEEP_ENTITY_TABLES: Record<FrogSleepEntityKind, string> = {
  ...
  buddy_share: "zook_frogsleep_buddy_shares",
  buddy_interaction: "zook_frogsleep_buddy_interactions",
  buddy_joint_activity: "zook_frogsleep_buddy_joint_activities",
  buddy_joint_goal: "zook_frogsleep_buddy_joint_goals",
  buddy_goal_contribution: "zook_frogsleep_buddy_goal_contributions",
  buddy_milestone: "zook_frogsleep_buddy_milestones",
  buddy_weekly_report: "zook_frogsleep_buddy_weekly_reports",
